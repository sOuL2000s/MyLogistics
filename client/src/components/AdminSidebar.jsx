  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-10 mt-2 px-2">
        <Link to="/admin" className="text-2xl font-black text-white flex items-center gap-3">
          <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center text-sm font-bold">A</div> Admin
        </Link>
      ...
      <nav>
        <ul className="space-y-2">
          ...
          <li className="pt-10 border-t border-white/5 mt-6">
            <button
              onClick={logout}
